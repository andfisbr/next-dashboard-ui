...
-- CreateEnum
CREATE TYPE "DaysOfWorkWeek" AS ENUM ('MONDAY', 'TUESDAY', 'WEDNESDAY', 'THURSDAY', 'FRIDAY');
...
-- AddForeignKey
ALTER TABLE "Class" ADD CONSTRAINT "Class_gradeId_fkey" FOREIGN KEY ("gradeId") REFERENCES "Class"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
